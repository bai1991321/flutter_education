...
import 'package:education_app/ui/signup_screens/instructor_signup_screen.dart';
import 'package:education_app/ui/signup_screens/student_signup_screen.dart';
...
class RegistrationSelectScreen extends StatefulWidget {
  ...
  @override
  _RegistrationSelectScreenState createState() =>
      new _RegistrationSelectScreenState();
}

class _RegistrationSelectScreenState extends State<RegistrationSelectScreen> {
  ...
  Widget _buildSigUpSelectionWidget() {
    return new Builder(
              ...
              child: new Column(
                children: <Widget>[
                  SimpleRoundIconButton(
                      ...
                      buttonText: Text(
                        StringConstants.sign_up_with_email,
                        style: TextStyle(
                          color: Colors.white,
                          fontFamily: 'novabold',
                          fontSize: 16.0,
                        ...
                        if (role == StringConstants.student) {
                          Navigator.push(
                            ...
                            new MaterialPageRoute(
                                builder: (context) => new StudentSignUpScreen(
                                      auth: widget.auth,
                  ...
                  SimpleRoundIconButton(
                    ...
                    buttonText: Text(
                      StringConstants.sign_up_with_google,
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'novabold',
                        fontSize: 16.0,
                    ...
                    onPressed: () => signUpWithGoogle(context, _gSignIn),
                  ),
                  SimpleRoundIconButton(
                    backgroundColor: const Color(AppColors.facebookColor),
                    buttonText: Text(
                      StringConstants.sign_up_with_facebook,
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'novabold',
                        fontSize: 16.0,
                    ...
                    onPressed: () =>
                        signUpWithFacebook(context, facebookSignIn),
                  ),
                  Divider(
                    height: 40.0,
                    color: Colors.transparent,
                  ...
                  SimpleFlatButton(
                      ...
                      buttonText: Text(
                        StringConstants.have_account_text,
                        style: TextStyle(
                          color: Colors.black,
                          fontFamily: 'novabold',
                          fontSize: 17.0,
                      ...
                      onPressed: () => _navigateToLoginSelectScreens()),
                ],
              ),
            ));
  }

  void _navigateToLoginSelectScreens() {
  ...
  void signUpWithGoogle(BuildContext context, GoogleSignIn _gSignIn) async {
    setStateTask(true);
    try {
